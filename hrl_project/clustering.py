...
def make_clusters(env_name, n_clusters):
    ...
    data_normalized = np.zeros((data.shape[0], 2))
    data_normalized[:,0] = x_pos_normalized
    data_normalized[:,1] = velocity_normalized
