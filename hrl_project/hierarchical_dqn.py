...
class HierarchicalDqnAgent(object):
    ...
    INTRINSIC_TIME_OUT = 40             # Number of steps after which intrinsic episode ends.
    ...
    def __init__(self,
                 ...
                 use_intrinsic_timeout=True,
                 use_memory=False,
                 memory_size=0,
                 pretrain_controller=False):
        print("h-DQN")
        print("Use extra travel penalty:", use_extra_travel_penalty)
        print("Use extra bit for subgoal center:", use_extra_bit_for_subgoal_center)
        print("Use controller dqn:", use_controller_dqn)
        print("Use intrinsic timeout:", use_intrinsic_timeout)
        print("Use memory:", use_memory)
        print("Memory size:", memory_size)
        print("Pretrain Controller:", pretrain_controller)
        ...
        if subgoal_completed or terminal:
            ...
            if eval:
                if subgoal_completed:
                    ...
                    print("Intermediate Clusters:", self._intermediate_clusters)
                    print("Intermediate Cluster Count:",self._intermediate_dict)
                    print("Intermediate non-beginning cluster count:",self._intermediate_clusters_dict)
                    print("State:",next_state)
                    print("Meta-Controller reward:",self._meta_controller_reward)
                    print("Intrinsic reward:",intrinsic_reward)
                    print("Cluster:",next_meta_controller_state)
                    print("")
                else:
                    print("Terminal!")
                    print("Intermediate Clusters:",self._intermediate_clusters)
    ...
    def best_action(self, state):
        ...
        if self._meta_controller_state is None:
            ...
            print("Current Meta-Controller State:",self._meta_controller_state)
            print("Current subgoal picked:",self._curr_subgoal)
